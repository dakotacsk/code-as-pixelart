...
1. For a new reference image, call `pixelart_import_image`. Ask for dimensions only when the user's intended sprite scale is materially ambiguous; otherwise use 32 by 32 and 12 colors.
